...
//    v_position = in_position + in_example;
    v_position = in_position - vec4(0.0, 0.3, 0.0, 0.0);
  //  v_position.y = v_position.y - texelFetch(u_information_texture, 0).r;
    v_position = u_model * v_position;
  v_normal = normalize(u_model * in_normal);
  v_uv = in_uv;
  v_tangent = normalize(u_model * in_tangent);
  //  example = vec4(0, 1, 2, 3);
